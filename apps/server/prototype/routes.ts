...
function withPreviewUrl(proto: { id: string; userId: string; shareId: string; name: string; brief: string; logoData: string | null; palette: string | null; status: string; currentVersion: number; createdAt: Date; updatedAt: Date }) {
