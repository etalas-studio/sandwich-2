    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            {
              en: 'You keep ownership of the briefs you submit and the documents SANDWICH generates for you. You are responsible for having the right to submit any client content you paste into SANDWICH, and for reviewing generated output before relying on it commercially.',
              id: 'Kamu tetap memiliki brief yang kamu kirim dan dokumen yang dihasilkan SANDWICH untuk kamu. Kamu bertanggung jawab memastikan kamu punya hak untuk mengirim konten klien apa pun yang kamu tempel ke SANDWICH, dan untuk memeriksa output sebelum mengandalkannya secara komersial.',
            },
            {
        ...
        },
        {
          ...
          body: [
            {
              en: "Don't use SANDWICH to generate or distribute unlawful, infringing, or abusive content, attempt to bypass usage quotas or security controls, or resell access without our written agreement.",
              id: 'Jangan gunakan SANDWICH untuk menghasilkan atau menyebarkan konten ilegal, melanggar hak pihak lain, atau bersifat abusive, mencoba melewati batas kuota atau kontrol keamanan, atau menjual kembali akses tanpa persetujuan tertulis dari kami.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          body: [
            {
              en: 'We may update these terms as the product evolves; material changes will be reflected here with an updated date. Questions? Email support@etalas.ai.',
              id: 'Kami dapat memperbarui syarat ini seiring perkembangan produk; perubahan signifikan akan tercermin di sini dengan tanggal yang diperbarui. Ada pertanyaan? Email support@etalas.ai.',
            },
          ],
        },
      ]}
