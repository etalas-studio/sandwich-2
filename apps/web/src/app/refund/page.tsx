    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            {
              en: 'If a Pro payment is charged but never confirmed as successful (e.g. a failed or duplicate charge), we will refund it in full once verified. Email hello@etalas.com with your account email and payment reference.',
              id: 'Jika pembayaran Pro tertagih tapi tidak pernah terkonfirmasi berhasil (misalnya charge gagal atau duplikat), kami akan me-refund penuh setelah terverifikasi. Email hello@etalas.com dengan email akun dan referensi pembayaran kamu.',
            },
            {
        ...
        },
        {
          ...
          body: [
            {
              en: 'Email hello@etalas.com from your account email with the payment date and amount. We aim to respond within 2 business days and, once approved, process refunds to the original payment method within 7 business days.',
              id: 'Email hello@etalas.com dari email akun kamu dengan tanggal dan jumlah pembayaran. Kami berusaha merespons dalam 2 hari kerja dan, setelah disetujui, memproses refund ke metode pembayaran semula dalam 7 hari kerja.',
            },
          ],
        },
      ]}
