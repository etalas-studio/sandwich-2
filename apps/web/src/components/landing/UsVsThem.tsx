    ...
    <section id="differentiators" className="py-24 md:py-32 border-t border-white/5 scroll-mt-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.02] flex flex-col gap-6 opacity-70 grayscale transition hover:opacity-90 hover:grayscale-0">
            ...
            <ul className="space-y-4">
              {withoutItems.map((item) => (
                <li key={item} className="flex items-center gap-3" style={{ color: TEXT_SECONDARY }}>
                  <iconify-icon icon="solar:close-circle-linear" width="20" className="text-red-400/60" />
