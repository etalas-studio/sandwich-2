...
export function Harnesses(props: HarnessesProps) {
  return (
    <section id="harnesses" className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 bg-black/[0.015] scroll-mt-24">
      <div className="max-w-4xl mx-auto px-6 relative">
        ...
        <div className="relative rounded-2xl border border-black/10 bg-black/[0.02] p-8 sm:p-12">
