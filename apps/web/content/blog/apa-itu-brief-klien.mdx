...
Proses ini biasanya memakan waktu karena butuh banyak pertanyaan lanjutan dan diskusi. [SANDWICH](https://sandwich.etalas.com) mempersingkat proses ini secara signifikan: cukup masukkan brief (sekasar apapun), dan SANDWICH akan menghasilkan PRD, prototype, dan estimasi secara otomatis. Hasilnya bisa langsung digunakan sebagai bahan diskusi untuk menyempurnakan scope sebelum proyek dimulai.
