...
### 6. Timeline
Kapan produk ini perlu selesai? Ada deadline tertentu? Kalau ada alasan spesifik (misalnya ada event launching atau seasonal), jelaskan — ini mempengaruhi prioritas dan scope.
...
Proses ini biasanya memakan waktu karena butuh banyak pertanyaan lanjutan dan diskusi. [SANDWICH](https://sandwich.etalas.com) mempersingkat proses ini secara signifikan — kamu cukup masukkan brief (sekasar apapun), dan SANDWICH akan menghasilkan PRD, prototype, dan estimasi secara otomatis. Hasilnya bisa langsung digunakan sebagai bahan diskusi untuk menyempurnakan scope sebelum proyek dimulai.

---

Punya brief yang masih mentah? [Coba SANDWICH](https://sandwich.etalas.com/register) dan lihat apa yang bisa dihasilkan darinya.
